...
<div class="kt-section">
	<div class="kt-section__body">
		...
		<div class="form-group row">		
			...
			<div class="col-4">
				<div class="input-group">					
					<input name="c_city_vdc" type="text" class="form-control" value="<?=$address->city_vdc?>" placeholder="VDC/Municipality" >
				</div>
...
<?php if($enable_edit==false): ?>
	...
	<div class="kt-section">
		<div class="kt-section__body">
			...
			<div class="form-group  row">
			<label class="col-3 col-form-label">Current Address:</label>									
